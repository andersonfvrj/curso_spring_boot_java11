...
import br.com.p2pservicos.course.entities.Payment;
...
public class TestConfig implements CommandLineRunner { //Macete para criar os dados no BD no início do programa, tem que implementar a classe CommandLineRunner
	...
	public void run(String... args) throws Exception {
		...
		//Para salvar objetos que se relacionam de forma um para um, chama o metodo da classe principal
		o1.setPayment(pay1);
		orderRepository.save(o1); //Manda o JPA salvar o objeto
